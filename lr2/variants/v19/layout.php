...
function renderVariantLayout(string $content, string $taskName, string $bodyClass = ''): void
{
    ...
    $demoUrl = "/lr2/demo/{$currentTask}?from=v19";
    ?>
<!DOCTYPE html>
<html lang="uk">
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($taskName) ?> — Варіант 19 ЛР2</title>
...
<body class="body-with-header <?= htmlspecialchars($bodyClass) ?>">
    <header class="header-fixed">
        <div class="header-left">
            ...
            <a href="index.php" class="header-btn">← Варіант 19</a>
            <a href="<?= htmlspecialchars($demoUrl) ?>" class="header-btn header-btn-demo">Demo</a>
        </div>
        <div class="header-center"></div>
        <div class="header-right">
            <span class="header-variant-label">В-19</span>
